...
public class TestMP {
    ...
    private static String author ="Charles";//作者名称
    private static String outputDir ="D:\\mp";//生成的位置
    private static String driver ="com.mysql.cj.jdbc.Driver";//驱动，注意版本
    //连接路径,注意修改数据库名称
    private static String url ="jdbc:mysql://localhost:3306/db_admin?useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC";
    private static String username ="root";//数据库用户名
    private static String password ="root";//数据库密码
    private static String tablePrefix ="sys_";//数据库表的前缀，如tbl_user
    private static String [] tables = {"sys_user","sys_role","sys_menu","sys_user_role","sys_role_menu"};	//生成的表
    private static String parentPackage = "com.charles";//顶级包结构
    ...
    public void  testGenerator() {
        ...
        stConfig.setCapitalMode(true) //全局大写命名
                ...
                .setSuperEntityColumns("id","created","updated","statu");
